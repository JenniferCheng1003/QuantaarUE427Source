...
#include "FightingVRPlayerController.generated.h"

class AFightingVRHUD;

UCLASS(config=Game)
class AFightingVRPlayerController : public APlayerController
{
...
// 	virtual void Emote(const FString& Msg);
	...
	void OnDeathMessage(class AFightingVRPlayerState* KillerPlayerState, class AFightingVRPlayerState* KilledPlayerState, const UDamageType* KillerDamageType);
	...
	// begin AFightingVRPlayerController-specific
	...
	/** Returns a pointer to the FightingVR game hud. May return NULL. */
	AFightingVRHUD* GetFightingVRHUD() const;
	...
	// end AFightingVRPlayerController-specific
...
protected:
	...
	TSharedPtr<class FFightingVRIngameMenu> FightingVRIngameMenu;
...
public:
	...
	float FightingVRFriendUpdateTimer;
