...
#include "FightingVRCharacter.generated.h"

DECLARE_MULTICAST_DELEGATE_TwoParams(FOnFightingVRCharacterEquipWeapon, AFightingVRCharacter*, AFightingVRWeapon* /* new */);
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnFightingVRCharacterUnEquipWeapon, AFightingVRCharacter*, AFightingVRWeapon* /* old */);

UCLASS(Abstract)
class AFightingVRCharacter : public ACharacter
{
	...
	*/
	void AddWeapon(class AFightingVRWeapon* Weapon);
	...
	*/
	void RemoveWeapon(class AFightingVRWeapon* Weapon);
	...
	*/
	class AFightingVRWeapon* FindWeapon(TSubclassOf<class AFightingVRWeapon> WeaponClass);
	...
	*/
	void EquipWeapon(class AFightingVRWeapon* Weapon);
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Game|Weapon")
	class AFightingVRWeapon* GetWeapon() const;

	/** Global notification when a character equips a weapon. Needed for replication graph. */
	FIGHTINGVR_API static FOnFightingVRCharacterEquipWeapon NotifyEquipWeapon;

	/** Global notification when a character un-equips a weapon. Needed for replication graph. */
	FIGHTINGVR_API static FOnFightingVRCharacterUnEquipWeapon NotifyUnEquipWeapon;
	...
	*/
	class AFightingVRWeapon* GetInventoryWeapon(int32 index) const;
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = Inventory)
	TArray<TSubclassOf<class AFightingVRWeapon> > DefaultInventoryClasses;

	/** weapons in inventory */
	UPROPERTY(Transient, Replicated)
	TArray<class AFightingVRWeapon*> Inventory;

	/** currently equipped weapon */
	UPROPERTY(Transient, ReplicatedUsing = OnRep_CurrentWeapon)
	class AFightingVRWeapon* CurrentWeapon;
...
protected:
	...
	void SetCurrentWeapon(class AFightingVRWeapon* NewWeapon, class AFightingVRWeapon* LastWeapon = NULL);

	/** current weapon rep handler */
	UFUNCTION()
	void OnRep_CurrentWeapon(class AFightingVRWeapon* LastWeapon);
	...
	void ServerEquipWeapon(class AFightingVRWeapon* NewWeapon);
