...
#include "FightingVRWeapon.h"
#include "FightingVRWeapon_Instant.generated.h"

class AFightingVRImpactEffect;
...
UCLASS(Abstract)
class AFightingVRWeapon_Instant : public AFightingVRWeapon
{
...
protected:
	...
	TSubclassOf<AFightingVRImpactEffect> ImpactTemplate;
