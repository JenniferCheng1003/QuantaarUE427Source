...
#include "FightingVRWeapon.generated.h"
...
class AFightingVRWeapon : public AActor
{
	...
	virtual void OnEquip(const AFightingVRWeapon* LastWeapon);
	...
	virtual void OnEnterInventory(AFightingVRCharacter* NewOwner);
	...
	class AFightingVRCharacter* GetPawnOwner() const;
	...
	void SetOwningPawn(AFightingVRCharacter* AFightingVRCharacter);
...
protected:
	...
	class AFightingVRCharacter* MyPawn;
...
protected:
	...
	virtual void FireWeapon() PURE_VIRTUAL(AFightingVRWeapon::FireWeapon,);
