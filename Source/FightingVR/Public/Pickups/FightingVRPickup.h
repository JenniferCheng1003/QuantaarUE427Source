...
#include "FightingVRPickup.generated.h"

// Base class for pickup objects that can be placed in the world
UCLASS(abstract)
class AFightingVRPickup : public AActor
{
	...
	virtual bool CanBePickedUp(class AFightingVRCharacter* TestPawn) const;
...
protected:
	...
	AFightingVRCharacter* PickedUpBy;
	...
	/** give pickup */
	virtual void GivePickupTo(class AFightingVRCharacter* Pawn);

	/** handle touches */
	void PickupOnTouch(class AFightingVRCharacter* Pawn);
