...
class AFightingVRState;

class FIGHTINGVR_API FFightingVROnlineGameMatches
{
public:
	FFightingVROnlineGameMatches()
	{
	}
	...
	void Initialize(AFightingVRState* InGameState, UFightingVRInstance* InGameInstance);
...
protected:
	...
	AFightingVRState* GameState = nullptr;
	UFightingVRInstance* GameInstance = nullptr;
};