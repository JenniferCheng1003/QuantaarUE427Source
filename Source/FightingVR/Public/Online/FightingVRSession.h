...
#include "FightingVRSession.generated.h"

struct FFightingVRSessionParams
{
...
UCLASS(config=Game)
class FIGHTINGVR_API AFightingVRSession : public AGameSession
{
...
protected:
	...
	FFightingVRSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FFightingVROnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FFightingVROnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(AFightingVRSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(AFightingVRSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(AFightingVRSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(AFightingVRSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
