...
#include "FightingVRHUD.generated.h"
...
struct FDeathMessage
{
	...
	TWeakObjectPtr<class UFightingVRDamageType> DamageType;
...
UCLASS()
class AFightingVRHUD : public AHUD
{
...
public:
	...
	/** Sent from FightingVRWeapon, shows NO AMMO text. */
	 ...
	 */
	void SetMatchState(EFightingVRMatchState::Type NewState);

	/** Get state of current match. */
	EFightingVRMatchState::Type GetMatchState() const;
	 ...
	 */
	void ShowDeathMessage(class AFightingVRPlayerState* KillerPlayerState, class AFightingVRPlayerState* VictimPlayerState, const UDamageType* KillerDamageType);
...
protected:
	...
	/** Scoreboard widget. */
	TSharedPtr<class SFightingVRScoreboardWidget>	ScoreboardWidget;
