...
{
	FightingVRHUDPCTrackerBase::Init(InContext);

	ChatStyle = &FFightingVRStyle::Get().GetWidgetStyle<FFightingVRChatStyle>("DefaultFightingVRChatStyle");
	...
	ChatFont = FFightingVRStyle::Get().GetFontStyle("FightingVR.ChatFont");
