...
DECLARE_DELEGATE_RetVal_OneParam(int32, FOnGetPlayerStateAttribute, AFightingVRPlayerState*);
...
//class declare
class SFightingVRScoreboardWidget : public SBorder
{

	SLATE_BEGIN_ARGS(SFightingVRScoreboardWidget)
	{}

	SLATE_ARGUMENT(TWeakObjectPtr<APlayerController>, PCOwner)

	SLATE_ATTRIBUTE(EFightingVRMatchState::Type, MatchState)
...
protected:
	...
	AFightingVRPlayerState* GetSortedPlayerState(const FTeamPlayer& TeamPlayer) const;
	...
	int32 GetAttributeValue_Kills(class AFightingVRPlayerState* PlayerState) const;

	/** get attribute value for deaths */
	int32 GetAttributeValue_Deaths(class AFightingVRPlayerState* PlayerState) const;

	/** get attribute value for score */
	int32 GetAttributeValue_Score(class AFightingVRPlayerState* PlayerState) const;
	...
	EFightingVRMatchState::Type MatchState;

	/** pointer to our parent HUD */
	TWeakObjectPtr<class APlayerController> PCOwner;

	/** style for the scoreboard */
	const struct FFightingVRScoreboardStyle *ScoreboardStyle;
};
