...
class SFightingVRConfirmationDialog : public SCompoundWidget
{
public:
	...
	EFightingVRDialogType::Type DialogType;

	SLATE_BEGIN_ARGS( SFightingVRConfirmationDialog )
	{}

	SLATE_ARGUMENT(TWeakObjectPtr<ULocalPlayer>, PlayerOwner)
	SLATE_ARGUMENT(EFightingVRDialogType::Type, DialogType)
