...
class FFightingVRRecentlyMet : public TSharedFromThis<FFightingVRRecentlyMet>
{
public:
	...
	TSharedPtr<FFightingVRMenuItem> RecentlyMetItem;

	/** holds Recently Met menu item */
	TSharedPtr<FFightingVRMenuItem> RecentlyMetRoot;
...
protected:
	...
	const struct FFightingVROptionsStyle *RecentlyMetStyle;
};