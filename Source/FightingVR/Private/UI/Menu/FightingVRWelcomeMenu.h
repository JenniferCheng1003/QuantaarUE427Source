...
class FFightingVRWelcomeMenu : public TSharedFromThis<FFightingVRWelcomeMenu>
{
public:
	/** build menu */
	void Construct( TWeakObjectPtr< class UFightingVRInstance > InGameInstance );
	...
	TWeakObjectPtr< class UFightingVRInstance > GetGameInstance() { return GameInstance; }

private:
	/** Owning game instance */
	TWeakObjectPtr< class UFightingVRInstance > GameInstance;
