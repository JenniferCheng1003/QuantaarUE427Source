...
class UFightingVRInstance;

class FFightingVRMessageMenu : public TSharedFromThis<FFightingVRMessageMenu>
{
public:
	/** build menu */
	void Construct(TWeakObjectPtr<UFightingVRInstance> InGameInstance, TWeakObjectPtr<ULocalPlayer> InPlayerOwner, const FText& Message, const FText& OKButtonText, const FText& CancelButtonText,  const FName& InPendingNextState);
