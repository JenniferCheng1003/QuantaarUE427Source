...
{
	AFightingVRAIController* MyController = Cast<AFightingVRAIController>(InActor);
				...
				if (Hit.GetActor() != NULL)
				{
					...
					else
					{
							...
							&& (MyController->PlayerState != NULL) && (HitChar->GetPlayerState() != NULL))
						{
							...
							AFightingVRPlayerState* MyPlayerState = Cast<AFightingVRPlayerState>(MyController->PlayerState);
